var Novella = (function (Vue) {
  ...
  console.log("Generated by novella at 10/24/2016, 12:58:31 AM.");
  ...
  var PageList = { template: "<ul class=\"page-list\" :style=\"{ height: getTotalHeight() + 'px' }\"><li v-for=\"n in visiblePages\" :data-highlight=\"isSelected(n)\" :key=\"getSource(n)\" :style=\"{ top: getPosition(n) + 'px' }\"><a :href=\"getRoute(n)\"><page-content :src=\"getSource(n)\"></page-content><div class=\"pagenum\">{{ n }}</div></a></li></ul>",
    props: {
      store: store$1,
      visiblePages: Array,
    },
  ...
  var Sidebar = { template: "<div class=\"sidebar\" v-on:scroll=\"updateVisiblePages()\"><h1>{{ store.title }}</h1><page-list :store=\"store\" :visible-pages=\"visiblePages\" ref=\"pagelist\"></page-list></div>",
      props: { store: store$1 },
      data: () => ({
        visiblePages: [],
      }),
      ...
      methods: {
        ...
        updateVisiblePages() {
          ...
          var visiblePages = [];
          this.store.pages.forEach((page$$1, n) => {
