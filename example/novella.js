var Novella = (function (Vue) {
  ...
  console.log("Generated by novella at 10/22/2016, 8:08:26 PM.");
  ...
  var PageList = { template: "<ul class=\"page-list\"><li v-for=\"n in Math.min(length, 10)\"><a :href=\"getRoute(n)\" :data-index=\"n\"><img v-if=\"isImage(n)\" :src=\"getSource(n)\"> <span>{{ n }}</span></a></li></ul>",
    props: {
      pages,
      route: String,
    },
  ...
  var App = { template: "<div class=\"app\"><div class=\"sidebar\"><h1>{{ title }}</h1><page-list :pages=\"pages\" :route=\"pageRoute\"></page-list></div><page :page=\"pages[selectedPage - 1]\"></page></div>",
    props: {
      title: String,
      pages,
      pageRoute: String,
