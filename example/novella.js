var Novella = (function (Vue) {
  ...
  console.log("Generated by novella at 10/24/2016, 2:09:24 AM.");
  ...
  function scrollToRange(parent, [top, bottom]) {
    ...
    console.log(parent.scrollTop, parentRect.bottom, [top, bottom]);
  ...
  var Sidebar = { template: "<div class=\"sidebar\" v-on:scroll=\"updateVisiblePages()\" :style=\"{ width: width + 'px', padding: pad + 'px' }\"><h1>{{ store.title }}</h1><page-list :store=\"store\" :visible-pages=\"visiblePages\" :positions=\"positions\" :content-style=\"getListContentStyle()\" :style=\"getListStyle()\" ref=\"pagelist\"></page-list></div>",
    props: { store: store$1 },
    computed: {
      positions() {
        var total = 0;
