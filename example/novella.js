var Novella = (function (Vue) {
  ...
  console.log("Generated by novella at 10/23/2016, 8:00:50 PM.");
  ...
  var PageList = { template: "<ul class=\"page-list\"><li v-for=\"n in Math.min(length, 10)\" :data-highlight=\"isSelected(n)\" :key=\"getSource(n)\"><a :href=\"getRoute(n)\"><page-content :src=\"getSource(n)\"></page-content><div class=\"pagenum\">{{ n }}</div></a></li></ul>",
    props: { store: store$1 },
    computed: {
