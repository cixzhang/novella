var Novella = (function (Vue) {
  ...
  console.log("Generated by novella at 10/22/2016, 8:47:26 PM.");
  ...
  var App = { template: "<div class=\"app\"><div class=\"sidebar\"><h1>{{ title }}</h1><page-list :pages=\"pages\" :route=\"pageRoute\" :selected-page=\"selectedPage\"></page-list></div><page :page=\"pages[selectedPage - 1]\"></page></div>",
    props: {
      title: String,
      pages,
      pageRoute: String,
