var Novella = (function (Vue) {
  ...
  console.log("Generated by novella at 10/22/2016, 10:51:10 PM.");
  ...
  var App = { template: "<div class=\"app\" :data-close-sidebar=\"hideSidebar && !animateSidebar\"><div class=\"sidebar\" :data-animation=\"animateSidebar\" v-on:animationend=\"onAnimationEnd()\"><h1>{{ title }}</h1><page-list :pages=\"pages\" :route=\"pageRoute\" :selected-page=\"selectedPage\"></page-list></div><div class=\"content\"><button class=\"sidebar-toggle\" v-on:click=\"toggleSidebar()\">{{ hideSidebar ? 'show menu' : 'hide menu' }}</button><page :page=\"pages[selectedPage - 1]\"></page></div></div>",
    props: {
      title: String,
      pages,
      pageRoute: String,
