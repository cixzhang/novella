var Novella = (function (Vue) {
  ...
  console.log("Generated by novella at 10/24/2016, 2:32:53 AM.");
  ...
  var Sidebar = { template: "<div class=\"sidebar\" v-on:scroll=\"updateVisiblePages()\" :style=\"{ width: width + 'px', padding: padding + 'px' }\"><h1>{{ store.title }}</h1><page-list :store=\"store\" :visible-pages=\"visiblePages\" :positions=\"positions\" :content-style=\"getListContentStyle()\" :style=\"getListStyle()\" ref=\"pagelist\"></page-list></div>",
    props: { store: store$1 },
    computed: {
      positions() {
        var total = 0;
