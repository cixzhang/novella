var Novella = (function (Vue) {
  ...
  console.log("Generated by novella at 10/23/2016, 1:30:21 PM.");
  ...
  var PageList = { template: "<ul class=\"page-list\"><li v-for=\"n in Math.min(length, 10)\" :data-selected=\"isSelected(n)\" :key=\"getSource(n)\"><a :href=\"getRoute(n)\"><img v-if=\"isImage(n)\" :src=\"getSource(n)\"> <span>{{ n }}</span></a></li></ul>",
    props: { store: store$1 },
    computed: {
