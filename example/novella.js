var Novella = (function (Vue) {
  ...
  console.log("Generated by novella at 10/23/2016, 5:46:53 PM.");
  ...
  var App = { template: "<div class=\"app\"><transition name=\"slide\"><sidebar v-if=\"store.showsidebar\" :store=\"store\"></sidebar></transition><gallery :store=\"store\"></gallery></div>",
    props: { store: store$1 },
    components: {
      Gallery,
      Sidebar,
